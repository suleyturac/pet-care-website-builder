  ...
  return (
    <section id="about" className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-background">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-14">
        <div className="rounded-2xl overflow-hidden h-[350px] bg-yellow-soft">
          <img src={vetExamining} alt="Vet examining a pet" className="w-full h-full object-cover" loading="lazy" width={768} height={1024} />
        </div>
        <div className="rounded-2xl overflow-hidden h-[350px] bg-blue-soft">
        ...
        {stats.map((stat, i) => (
          <div key={i}>
            <div className="text-4xl md:text-5xl font-heading text-foreground">
              {stat.number}<span className={stat.color}>{stat.suffix}</span>
            </div>
