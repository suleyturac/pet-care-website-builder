...
import { Home, Clock, Shield, Heart } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="px-6 md:px-12 lg:px-20 pt-16 pb-10">
        ...
        <h1 className="text-3xl md:text-5xl font-heading text-foreground mt-6 mb-4">
          Trusted Pet <span className="font-accent">Sitting</span> Services
        </h1>
        <p className="text-muted-foreground font-body text-base max-w-2xl mb-8">
          Going on vacation or working late? Our pet sitters come to your home to care for your pets in their familiar environment. From feeding and playtime to medication administration, we handle it all with love.
        </p>
        <a href="tel:3476338034"><Button className="rounded-full bg-primary text-primary-foreground px-8 py-3 font-body">Book Pet Sitting</Button></a>
      </section>
      <section className="px-6 md:px-12 lg:px-20 py-12 bg-muted">
        <h2 className="text-2xl md:text-3xl font-heading text-foreground mb-8">What's Included</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: Home, title: "In-Home Comfort", desc: "Your pet stays in their own environment — less stress, more comfort." },
            { icon: Clock, title: "Flexible Visits", desc: "Short check-ins or extended stays, whatever your pet needs." },
            { icon: Shield, title: "Safe & Secure", desc: "We follow your routines and keep your home secure." },
            { icon: Heart, title: "All Pets Welcome", desc: "Dogs, cats, birds, reptiles — we care for them all." },
          ].map((item, i) => (
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16">
        <h2 className="text-2xl md:text-3xl font-heading text-foreground mb-4">Pet Sitting Service Areas</h2>
      ...
      <section className="px-6 md:px-12 lg:px-20 py-12 bg-lime rounded-3xl mx-6 md:mx-12 lg:mx-20 mb-16">
        <div className="text-center">
          <h2 className="text-2xl md:text-3xl font-heading text-foreground mb-3">Need a Pet Sitter?</h2>
          <p className="text-muted-foreground font-body text-sm mb-6">We're here for your pet, day or night.</p>
